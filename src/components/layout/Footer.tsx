...
import { SOCIAL_LINKS, getWhatsAppLink } from '../../constants/social';
      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">
              Join India's most exciting cycling community. Ride together, challenge yourself, and celebrate every milestone with fellow cyclists.
            </p>
            <div className="mt-4">
              <a
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href={getWhatsAppLink('Hi! I have a question about GlycoGrit.')}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div>
            ...
            <p className="text-xs mt-4 text-gray-400">
              Join us on our rides and be part of India's fastest-growing cycling community!
            </p>
          </div>
        </div>
